...
#        title="There is no associated research grant")
    ...
    activity = colander.SchemaNode(colander.String(), title="Research Grant",
        ...
        widget=deform.widget.AutocompleteInputWidget(min_length=1, values='/search/activities/', template="activities_autocomplete_input"))
    ...
    data_manager = colander.SchemaNode(colander.String(), title="Data Manager (Primary contact)",
        ...
        placeholder="eg. TODO: data manager of artificial tree",
    ...
    project_lead = colander.SchemaNode(colander.String(), title="Project Lead (Supervisor)",
        widget=deform.widget.AutocompleteInputWidget(min_length=1, values=choices),
        placeholder="eg. Dr Jeremy Vanderwal",
