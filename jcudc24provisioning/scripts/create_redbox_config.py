...
##    "metaList": [...]
    ...
    dict_config = {
        ...
        "mappings": {
            ...
            "/%s" % Metadata.record_origin.key:  "dc:identifier.redbox:origin", #TODO: What should this be prefilled with? Internal or something like rdc?
...
#    "dc:identifier.dc:type.skos:prefLabel": "",
            ...
            "/%s" % Metadata.activity.key: "foaf:fundedBy.vivo:Grant.0.dc:identifier",
...
#                Party.primary: "dc:creator.foaf:Person.0.redbox:isPrimaryInvestigator",
                ...
                Party.organisation_labl.key: "dc:creator.foaf:Person.0.foaf:Organization.skos:prefLabel",
            ...
            "/%s" % Metadata.brief_description.key: ["description", "dc:description", "rif:description.0.value"],
            "/%s" % Metadata.full_description.key: "rif:description.0.value",
            ...
            "/%s" % Metadata.locations.key: {
                Location.location_type.key: "dc:coverage.vivo:GeographicLocation.0.dc:type", # TODO: create hidden field prefilled with text.
                Location.name.key: "",             #TODO: Do something with location names and elevations.
                Location.location.key: ["dc:coverage.vivo:GeographicLocation.0.redbox:wktRaw", "dc:coverage.vivo:GeographicLocation.0.rdf:PlainLiteral"],
            ...
            "/%s" % Metadata.citation_place_of_publication.key: ["dc:biblioGraphicCitation.dc:hasPart.vivo:Publisher.vivo:Location","dc:biblioGraphicCitation.dc:hasPart.dc:date.0.rdf:PlainLiteral"],
            "/%s" % Metadata.citation_dates.key: {
                CitationDate.label.key: "dc:biblioGraphicCitation.dc:hasPart.dc:date.0.dc:type.skos:prefLabel", # TODO: Get this label as the name in the dropdown (datetype is the value)
            ...
            "/%s" % Metadata.use_curation.key: "dc:biblioGraphicCitation.dc:hasPart.dc:identifier.skos:note",   # TODO: Citation->use identifier provided during curation? - Ask if this should be on?
