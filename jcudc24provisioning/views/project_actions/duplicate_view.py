...
#
#    @view_config(renderer="../../templates/workflow_form.pt", name="submit_duplicate")   # Use ../../templates/submit.pt for AJAX - File upload doesn't work due to jquery/deform limitations
#    def submit(self):
...
#
#    @view_config(renderer="../../templates/workflow_form.pt", name="duplicate")
