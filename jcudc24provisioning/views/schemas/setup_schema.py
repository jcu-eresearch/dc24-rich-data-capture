...
class setup_schema(colander.MappingSchema):
    ...
    fullDescription = colander.SchemaNode(colander.String(), widget=deform.widget.TextAreaWidget(rows=6),
    ...
    dataManager = colander.SchemaNode(colander.String(), title="Data Manager",
    ...
    projectLead = colander.SchemaNode(colander.String(), title="Project Lead",
        widget=deform.widget.AutocompleteInputWidget(min_length=1, values=choices),
        default="Autocomplete from JCU's accounts (press the 'Other' tick box for non-JCU)",
