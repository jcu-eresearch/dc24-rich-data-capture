...
class setup_schema(colander.MappingSchema):
    project_title = colander.SchemaNode(colander.String(), widget=deform.widget.TextInputWidget(css_class="full_width"),
        placeholder="An easily identifiable, concise what and why - Include relevant keyword - Keep the description relevant to all generated records.", title="Project Title",
    ...
    brief_description = colander.SchemaNode(colander.String(), help="Descriptive help text test",
        placeholder="An executive summary of the full description - Keep the description relevant to all generated records", widget=deform.widget.TextAreaWidget(rows=3),
    ...
    full_description = colander.SchemaNode(colander.String(), widget=deform.widget.TextAreaWidget(rows=6),
        title="Full Description", placeholder="Full description of the project - Keep the description relevant to all generated records",
    ...
    data_manager = colander.SchemaNode(colander.String(), title="Data Manager",
        ...
        placeholder="Autocomplete from JCU's accounts (press the 'Other' tick box for non-JCU)",
