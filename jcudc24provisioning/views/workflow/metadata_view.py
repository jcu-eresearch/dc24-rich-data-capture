...
class MetadataView(Workflows):
    ...
    def __init__(self, request):
        ...
        self.schema = MetadataData(description="<b>Please fill this section out completely</b> - it's purpose is to provide the majority of information for all generated metadata records so that you don't have to enter the same data more than once:" \
