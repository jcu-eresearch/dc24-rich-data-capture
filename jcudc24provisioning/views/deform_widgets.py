"""
This module contains custom deform widgets to acheive additional form elements required for the EnMaSSe system.
"""
...
class ConditionalCheckboxMapping(Widget):
    """
    Widget that hides/shows the following form element based on if this widgets checkbox is selected.
    """
...
class MethodSchemaWidget(Widget):
    """
    Specialised mapping widget for the methods page, this is required for the parent schema functionality(s).
    """
